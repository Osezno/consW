...
<p><h2 style="color: #ff5216;    font-size: 25px; border-bottom: solid 1px #000; width: 80%;">User</h2>
...
<p><h2 style="color: #ff5216;    font-size: 25px; border-bottom: solid 1px #000; width: 80%;    margin-top: 20px;">User details</h2>
<?php
	printf(
...
?></p>
<h2 style="color: #ff5216;    font-size: 25px; border-bottom: solid 1px #000; width: 80%;    margin-top: 20px;">Addres</h2>
<?php
/**
 * My Addresses
 *
