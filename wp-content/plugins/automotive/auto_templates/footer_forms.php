...
if((!isset($lwp_options['forms_on_all_pages']) || empty($lwp_options['forms_on_all_pages'])) || is_singular('listings')){ ?>
<div id="email_fancybox_form" class="" style="display: none">
	<?php if ( ! isset( $lwp_options['email_friend_form_shortcode'] ) || empty( $lwp_options['email_friend_form_shortcode'] ) ) { ?>
		...
		<form name="email_friend" method="post" class="ajax_form" data-nonce="<?php echo wp_create_nonce("automotive-form-friend"); ?>">
			<table>
				<tr>
					<td><label for="friend_form_name"><?php _e( "Name", "listings" ); ?></label>:</td>
					<td><input type="text" name="name" id="friend_form_name"></td>
				</tr>
				<tr>
					<td><label for="friend_form_email"><?php _e( "Email", "listings" ); ?></label>:</td>
					<td><input type="text" name="email" id="friend_form_email"></td>
				</tr>
				<tr>
					<td><label for="friend_form_friend_email"><?php _e( "Friends Email", "listings" ); ?></label>:</td>
