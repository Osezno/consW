	...
	<div class="select-wrapper pagination clearfix margin-bottom-15">
		<div class="row">
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sort-by-menu">
				...
				$sort_by_style         = (isset($lwp_options['sortby']) && $lwp_options['sortby'] == 1 ? "" : " style='display: none;'"); ?>
						...
						<select name="price_order" class="listing_filter" tabindex="1" >
							...
							if(!empty($listing_orderby)){
								...
								if(empty($listing_orderby_url)){
									$listing_orderby_url = (isset($lwp_options['sortby_default']) && !empty($lwp_options['sortby_default']) && $lwp_options['sortby_default'] == 1 ? "ASC" : "DESC");
								}
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right">
				<ul class="form-links top_buttons">
					...
					<?php }
					if(isset($lwp_options['car_comparison']) && $lwp_options['car_comparison']){ ?>
