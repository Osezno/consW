...
$listings   = $Listing->current_query_info['total'];
...
echo '<div class="row">';
echo '<div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 padding-none" ' . (isset($hide_vehicles_matching) && $hide_vehicles_matching == "true" ? "style='display: none;'" : "") . '> <span class="ribbon"><strong><span class="number_of_listings">' . $listings . '</span> <span class="listings_grammar">' . ($listings == 1 ? $vehicle_singular : $vehicle_plural) . '</span> ' . $matching . ':</strong></span> <ul class="ribbon-item filter margin-bottom-none" data-all-listings="' . $all_listings . '">';
...
$lwp_options['inventory_listing_toggle'] = (isset($hide_select_view) && $hide_select_view == "true" ? false : $lwp_options['inventory_listing_toggle']);
