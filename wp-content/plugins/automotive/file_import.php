...
function register_csv_menu_item() {
    ...
    add_submenu_page( 'edit.php?post_type=listings', __('Automotive Listings Import', 'listings'), __('File Import', 'listings'), (isset($lwp_options['file-import-permission']) && !empty($lwp_options['file-import-permission']) ? $lwp_options['file-import-permission'] : "manage_options"), 'file-import', 'automotive_file_import' );
}
    ...
    <div class="wrap auto_import">
        ...
        <?php } elseif(isset($_GET['import_file'])){ ?>
            ...
            <form method="post" id="csv_import" data-one-per="<?php _e("Only one per list!", "listings"); ?>" data-nonce="<?php echo wp_create_nonce("automotive_csv_import"); ?>">
	            ...
	            <?php if($Listing->is_yoast_active()){ ?>
