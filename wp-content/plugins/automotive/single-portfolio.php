...
function portfolio_related(){
	...
	if($second_query->have_posts()) : while ($second_query->have_posts() ) : $second_query->the_post(); 
		...
		if($format == "image"){
			...
			$thumbnail = "<img src='" . (isset($content[0]['related']['url']) && !empty($content[0]['related']['url']) ? $content[0]['related']['url'] : $Listing->auto_image($content[0], "full", true)) . "' alt='' class='img-responsive'>";
		}
	?>
						...
						echo "<div class=\"flexslider flexslider2\">";
							echo "<ul class=\"slides item\">";
							    ...
							    foreach($content as $image){
                                    ...
                                    echo "<img src='" . $Listing->auto_image($image, "full", true) . "' alt=''>";
									...
									echo "<div class=\"flexslider flexslider2\">";
										echo "<ul class=\"slides item\">";
                                            ...
                                            foreach($content as $image){
                                                echo "<li>";
                                                echo (isset($links[$i]) && !empty($links[$i]) ? "<a href='" . $links[$i] . "'>" : "");                                                                
                                                echo "<img src='" . $Listing->auto_image($image, "auto_portfolio", true) . "' alt=''>";
                                                echo (isset($links[$i]) && !empty($links[$i]) ? "</a>" : "");
                                                echo "</li>";
                                                $i++;
                                            }
