	...
	vc_map( array(
		...
		"params"   => array(
			...
			array(
				...
				"param_name"  => "order_by",
				"value"       => array( __("Ascending", "listings") => "ASC", __("Descending", "listings") => "DESC" ),
	...
	vc_map( array(
		...
		"params"   => array(
			...
			array(
				...
				"heading"     => __( "Type", "listings" ),
				"param_name"  => "map_type",
				"value"       => array( __("Roadmap", "listings") => "roadmap", __("Satellite", "listings") => "satellite", __("Hybrid", "listings") => "hybrid", __("Terrain", "listings") => "terrain" ),
