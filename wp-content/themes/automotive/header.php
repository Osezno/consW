...
<html <?php language_attributes(); ?> class="no-js"><head>
  ...
  <link rel='stylesheet'  href='http://agenciadepublicidadmonterrey.com/prana/wp-content/themes/automotive/css/multirange.css' type='text/css' media='all' />
	</head>
...
<div class="toolbar">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 ">
                            <ul class="right-none pull-right company_info">
                                ...
                                <li class="toolbar_phone"><a href="tel:<?php echo (isset($awp_options['toolbar_phone']) && !empty($awp_options['toolbar_phone']) ? $awp_options['toolbar_phone'] : "1-800-567-0123") ?>"><i class="fa fa-phone"></i> <?php echo (isset($awp_options['toolbar_phone']) && !empty($awp_options['toolbar_phone']) ? $awp_options['toolbar_phone'] : "1-800-567-0123") ?></a></li>
                                <?php } ?>

                                <?php if(isset($awp_options['toolbar_address_show']) && $awp_options['toolbar_address_show'] == 1){ ?>
                                <li class="address toolbar_address"><a href="<?php echo (isset($awp_options['toolbar_address_link']) && !empty($awp_options['toolbar_address_link']) ? get_permalink($awp_options['toolbar_address_link']) : "#"); ?>"><i class="fa fa-map-marker"></i> <?php echo (isset($awp_options['toolbar_address']) && !empty($awp_options['toolbar_address']) ? $awp_options['toolbar_address'] : "107 Sunset Blvd., Beverly Hills, CA  90210") ?></a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>
  ...
  <ul class="mobile2" width="100%" style=" list-style: none; ">
                                <?php if(isset($awp_options['toolbar_login_show']) && $awp_options['toolbar_login_show'] == 1){ ?>
                                <li class="toolbar_login"><a href="<?php echo (isset($awp_options['toolbar_login_link']) && !empty($awp_options['toolbar_login_link']) ? get_permalink($awp_options['toolbar_login_link']) : "#"); ?>" <?php echo (isset($awp_options['toolbar_login_link']) && !empty($awp_options['toolbar_login_link']) ? "" : 'data-toggle="modal" data-target="#login_modal"'); ?>><i class="fa fa-user"></i> <?php echo (isset($awp_options['toolbar_login']) && !empty($awp_options['toolbar_login']) ? $awp_options['toolbar_login'] : __("Login", "automotive")) ?></a></li>
                                <?php } ?>
                                   <li class="toolbar_cart" style="margin-left:50px;"><a href="../consignador-profile">Register</a></li>
                                <?php if(isset($awp_options['woocommerce_cart']) && $awp_options['woocommerce_cart'] == 1){ ?>
                                <li class="toolbar_cart" style="margin-left:50px;"><a href="<?php echo (isset($awp_options['woocommerce_cart_link']) && !empty($awp_options['woocommerce_cart_link']) ? get_permalink($awp_options['woocommerce_cart_link']) : "#"); ?>"><i class="fa fa-shopping-cart"></i> <?php _e("Cart", "automotive"); ?></a>
                                	<?php woocommerce_shopping_cart(); ?>
                                </li>
                                <?php } ?>

                                <?php if(isset($awp_options['toolbar_language_show']) && $awp_options['toolbar_language_show'] == 1){ ?>
                                <li class="toolbar_language"><a href="#"><i class="fa fa-globe"></i> <?php echo (isset($awp_options['toolbar_languages']) && !empty($awp_options['toolbar_languages']) ? $awp_options['toolbar_languages'] : __("Languages", "automotive")) ?></a>
					  ...
					  <ul class="desktop2 left-none">
                                <?php if(isset($awp_options['toolbar_login_show']) && $awp_options['toolbar_login_show'] == 1){ ?>
                                <li class="toolbar_login"><a href="<?php echo (isset($awp_options['toolbar_login_link']) && !empty($awp_options['toolbar_login_link']) ? get_permalink($awp_options['toolbar_login_link']) : "#"); ?>" <?php echo (isset($awp_options['toolbar_login_link']) && !empty($awp_options['toolbar_login_link']) ? "" : 'data-toggle="modal" data-target="#login_modal"'); ?>><i class="fa fa-user"></i> <?php echo (isset($awp_options['toolbar_login']) && !empty($awp_options['toolbar_login']) ? $awp_options['toolbar_login'] : __("Login", "automotive")) ?></a></li>
                                <?php } ?>
                                   <li class="toolbar_cart"><a href="../consignador-profile">Register</a></li>
                                <?php if(isset($awp_options['woocommerce_cart']) && $awp_options['woocommerce_cart'] == 1){ ?>
                                <li class="toolbar_cart"><a href="<?php echo (isset($awp_options['woocommerce_cart_link']) && !empty($awp_options['woocommerce_cart_link']) ? get_permalink($awp_options['woocommerce_cart_link']) : "#"); ?>"><i class="fa fa-shopping-cart"></i> <?php _e("Cart", "automotive"); ?></a>
                                	<?php woocommerce_shopping_cart(); ?>
                                </li>
                                <?php } ?>
								...
								if( has_nav_menu( "header-menu" )) {
                                    ...
                                    wp_nav_menu( 
                                        array('theme_location' => $header_menu_location,
                                    ...
                                    // mobile menu                                                          
                                    wp_nav_menu( 
                                        array('theme_location' => $mobile_menu_location,        
