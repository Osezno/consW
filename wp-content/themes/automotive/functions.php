...
.wp-core-ui .button-primary:active {
    ...
    -webkit-box-shadow: inset 0 2px 0 #1b1c1d;

    box-shadow: inset 0 2px 0 #1b1c1d;
...
.wp-core-ui .button-primary {
    ...
    border-color: #0c0c0c #040404 #060606;
    ...
    text-shadow: 0 -1px 1px #b5b9bb, 1px 0 1px #1a1a1b, 0 1px 1px #006799, -1px 0 1px #006799;

}

.ui-tabs.automotive_meta_tabs .ui-tabs-nav li {

  color:#fff !important;

    background: #1f1f1f;}

.ui-tabs.automotive_meta_tabs .ui-tabs-nav li a {color:#fff;}

.ui-tabs.automotive_meta_tabs .ui-tabs-nav {
...
class WCCPT_Product_Data_Store_CPT extends WC_Product_Data_Store_CPT {
    ...
    public function read( &$product ) {
        ...
        if ( ! $product->get_id() || ! ( $post_object = get_post( $product->get_id() ) ) || ! in_array( $post_object->post_type, array( 'listings', 'product' ) ) ) { // change birds with your post type
   ...
   public function get_product_type( $product_id ) {
        ...
        } elseif ( in_array( $post_type, array( 'listings', 'product' ) ) ) { // change birds with your post type
...
function mytheme_admin_bar_render() {
    ...
    $wp_admin_bar->add_menu( array(
        ...
        'id' => 'equipo', // link ID, defaults to a sanitized title value

        'title' => __('New Equipment +'), // link title

        'href' => admin_url( 'post-new.php?post_type=listings'), // name of file
...
//$allowed_roles = array('editor', 'administrator');
	...
	// Add a custom link to My Account menu
...
add_action( 'login_enqueue_scripts', 'hidedash' );
