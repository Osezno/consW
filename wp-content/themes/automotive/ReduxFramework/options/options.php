		        ...
		        array(
		            ...
		            'default'       => array(
			            ...
			            array(
				            ...
				            'title'     => __('Header menu hover text color', 'automotive'),
				            'color'     => '#FFFFFF',
				            'alpha'     => 1,
				            'selector'  => 'header .bottom-header .navbar-default .navbar-nav>li:hover>a, .navbar .navbar-nav li .dropdown-menu>li:hover>a, .dropdown .dropdown-menu li.dropdown .dropdown-menu>li:hover>a, body .navbar-default .navbar-nav .open .dropdown-menu>li:hover>a',
				            'mode'      => 'color',
				            'group'     => 'Header'
			            ),
			            array(
				            'id'        => 'header-menu-active-hover-color',
				            'title'     => __('Header menu active hover text color', 'automotive'),
				            'color'     => '#FFFFFF',
				            'alpha'     => 1,
				            'selector'  => 'header .bottom-header .navbar-default .navbar-nav .active:hover>a',
				            'mode'      => 'color',
				            'group'     => 'Header'
			            ),
		                array(
		                ...
		                array(
		                    ...
		                    'color'     => '#c7081b', 
		                    'alpha'     => 1, 
		                    'selector'  => '.bottom-header .navbar-default .navbar-nav> li:hover> a, .bottom-header .navbar-default .navbar-nav>.active>a:hover, .dropdown-menu>li>a:hover, .dropdown-menu>li.active>a:hover',
		                    'mode'      => 'background,background-color',  
		                    'group'     => 'Header'
		                ),
			            ...
			            array(
				            ...
				            'color'     => '#FFFFFF',
				            'alpha'     => 1,
				            'selector'  => '#secondary-banner, #secondary-banner .main-heading, #secondary-banner .secondary-heading-heading',
				            'mode'      => 'color',
				            'group'     => 'Secondary'
			            ),
			            array(
				            'id'        => 'secondary-text-shadow',
				            'title'     => __('Secondary Text Shadow', 'automotive'),
				            'color'     => '#000',
				            'alpha'     => 1,
				            'selector'  => '#secondary-banner',
				            'mode'      => 'text-shadow',
