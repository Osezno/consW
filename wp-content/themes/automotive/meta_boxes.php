...
function page_options(){
    ...
    <label><?php _e("No header area", "automotive"); ?>: <input type="checkbox" value="no_header" name="no_header"<?php echo ((isset($no_header) && !empty($no_header) && $no_header == "no_header") || (isset($awp_options['no_header_area_default']) && $awp_options['no_header_area_default'] == 1 && auto_is_edit_page('new')) ? " checked='checked'" : ""); ?>></label><br>

	<label><?php _e("No header shadow", "automotive"); ?>: <input type="checkbox" value="no_header_shadow" name="no_header_shadow"<?php echo ((isset($no_header_shadow) && !empty($no_header_shadow) && $no_header_shadow == "no_header_shadow") ? " checked='checked'" : ""); ?>></label>
